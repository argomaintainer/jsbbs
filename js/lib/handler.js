            ...
            if(data.success){
                ...
                if((!$G.userfav
                   ...
                   || (localStorage['switch::say-hello'] &&
                    ...
                    t += '<div class="say-hello">进版后跟版友们打个招呼？<br><a href="#" data-submit="remove_notes" class="btn btn-success">我待会就发个贴子打个招呼</a><a data-submit="remove_notes" class="btn">我不打招呼</a><div>';
